          ...
          <BlackBox>
            ...
            >
              <Card className="rounded-full">
                <CardMedia
                  image={
                    "https://res.cloudinary.com/dcn64hytu/image/upload/v1732705692/AuraMart-images/brands/polo_offfh4.jpg"
                  }
                  className="w-40 h-20 "
                />
              </Card>
              <Card className="rounded-full">
                <CardMedia
                  image={
                    "https://res.cloudinary.com/dcn64hytu/image/upload/v1732705691/AuraMart-images/brands/HM_camlg4.png"
                  }
                  className="w-40 h-20 "
                />
              </Card>
              <Card className="rounded-full">
                <CardMedia
                  image={
                    "https://res.cloudinary.com/dcn64hytu/image/upload/v1732705692/AuraMart-images/brands/levis_aolpsn.png"
                  }
                  className="w-40 h-20 "
                />
              </Card>
              <Card className="rounded-full">
                <CardMedia
                  image={
                    "https://res.cloudinary.com/dcn64hytu/image/upload/v1732705692/AuraMart-images/brands/puma_kcnzk7.png"
                  }
                  className="w-40 h-20 "
                />
              </Card>
              <Card className="w-40 h-20 rounded-full">
                <CardMedia
                  image={
                    "https://res.cloudinary.com/dcn64hytu/image/upload/v1732705691/AuraMart-images/brands/nike_aftllh.png"
                  }
                  className="w-40 h-16 "
                />
              </Card>
