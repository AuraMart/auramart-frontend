...
const CheckoutForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const fullAddress = `${formData.streetAddress}${formData.apt ? `, ${formData.apt}` : ""}, ${formData.city}, ${formData.state}, ${formData.postalCode}, Phone: ${formData.phone}`;

    // Log and pass data to PayHere
    console.log("Form Data Submitted:", formData);
