    ...
    <div className="flex justify-between p-4 bg-gray-200 w-[300] md:w-[1000] rounded-md h-28">
      ...
      <div className="flex">
        ...
        <div>
            ...
            <span className="text-sm font-light text-gray-500">2118 Tharindage Cir.Syracue,Connecticut 35624</span><br></br>
            <span className="text-sm font-light text-gray-500">(209) 555-0104</span>
        </div>
      </div>
      {/*button*/}
      <div>
